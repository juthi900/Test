...
{
    public class genreposit<Tbl_Entity> : reposit<Tbl_Entity> where Tbl_Entity : class
    {
        DbSet<Tbl_Entity> _dbSet;
        private perfumeShopEntities _DBEntity;
        public genreposit(perfumeShopEntities DBEntity)
        {
            _DBEntity = DBEntity;
